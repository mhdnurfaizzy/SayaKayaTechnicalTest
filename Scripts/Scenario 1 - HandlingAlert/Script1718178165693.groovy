...
Mobile.tap(findTestObject('Object Repository/android.widget.Button - Cupertino'), 0)

Mobile.tap(findTestObject('Object Repository/android.widget.Button - Alerts'), 0)
