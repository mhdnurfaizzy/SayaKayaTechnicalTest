...
Mobile.tap(findTestObject('Object Repository/android.widget.Button - Pull to refreshRefresh indicators'), 0)

Mobile.tap(findTestObject('Object Repository/android.widget.Button - Refresh'), 0)

Mobile.waitForElementPresent(findTestObject('android.view.View - Refresh complete'), 20)

Mobile.verifyElementText(findTestObject('android.view.View - Refresh complete'), 'Refresh complete')
